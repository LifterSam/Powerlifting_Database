-- Hello, i made a training database and i wanted to have many entries i can work with. I asked ChatGPT to create fictional
-- data for my table and keep it accurate. This did not work too well i admit because i had to reevaluate most of the data afterwards and correct it by hand.
-- For example does a workout not consist of just one exercise. I myself do powerlifting and i do on avererage five different exercises per session.
-- That is why my dataset went in this direction. There is plenty of material now to choose from. The SELECT, UPDATE and DELETE statements
-- are on the end of this document, after the many insert rows. You can search the document for -- INSERT END HERE -- to find the start
-- of the demanded other statements.

INSERT INTO "Athletes" ("Name", "Surname", "Birth", "Gender", "WeightClass", "Experience") VALUES
...
INSERT INTO "Workouts" ("AthleteID", "Date", "notes") VALUES
...
INSERT INTO "Exercises" ("Name", "Category", "Musclegroup") VALUES
    ('Squat', 'Strength', 'Legs'),
...
INSERT INTO "Competitions" ("Name", "Date", "Location") VALUES
    ('European Powerlifting Championship', '2021-10-20', 'Berlin, Germany'),
    ('World Strongman Summit', '2021-07-30', 'Las Vegas, USA'),
    ('National Bodybuilding Classic', '2021-11-22', 'London, UK'),
    ('International Weightlifting Open', '2021-04-15', 'Paris, France'),
    ('American Strength Challenge', '2022-06-11', 'New York, USA'),
    ('Asian Powerlifting Meet', '2022-09-17', 'Tokyo, Japan'),
    ('Global Fitness Expo', '2023-05-14', 'Sydney, Australia'),
    ('Canadian Powerlifting Championship', '2023-08-22', 'Toronto, Canada'),
    ('UK Bodybuilding Pro Show', '2023-11-10', 'Manchester, UK'),
    ('World Powerlifting Grand Prix', '2023-05-14', 'Dubai, UAE');


INSERT INTO "CompetitionResults" ("AthleteID", "CompetitionID", "Squat", "Benchpress", "Deadlift", "Total", "DOTS", "Placement") VALUES
...
INSERT INTO "WorkoutExercises" ("WorkoutID", "ExerciseID", "Sets", "Reps", "Weight", "RPE") VALUES
    -- Workout 1
    (1, 3, 3, 10, 100.0, 8),
    (1, 12, 3, 8, 50.0, 7),
    (1, 24, 4, 12, 70.0, 9),
...
-- Let us look what the Athletes table looks like:
SELECT * FROM "Athletes";


-- Oh, the experience levels in the Athletes table are written in ze German (my native language). Let’s correct these to English:
UPDATE "Athletes"
SET "Experience" = CASE
    WHEN "Experience" = 'Anfänger' THEN 'Beginner'
    WHEN "Experience" = 'Fortgeschrittener' THEN 'Intermediate'
    WHEN "Experience" = 'Profi' THEN 'Advanced'
END;


-- ALARM, ALARM! Dubai has been removed from the international competition because of human rights violation!
-- Let us remove their record from our boards because all our athletes gave back their prices:
DELETE FROM "CompetitionResults"
WHERE "CompetitionID" = (              -- we need a subquery to find the foreign key IDs in the corresponding table CompetitionResults
    SELECT "CompetitionID"
    FROM "Competitions"
    WHERE "Name" = 'World Powerlifting Grand Prix' AND "Location" = 'Dubai, UAE'
);

DELETE FROM "Competitions"             -- after removing the entries in CompetitionsResults we can delete the competition itself
WHERE "Name" = 'World Powerlifting Grand Prix' AND "Location" = 'Dubai, UAE';


-- SELECT STATEMENTS

-- shows all entries in the Athletes table ordfered by their experience
SELECT * FROM "Athletes"
ORDER BY "experience";

-- shows an athlete with a certain ID
SELECT * FROM "Athletes" WHERE "AthleteID" = 3;

-- shows all workouts a certain athlete did
SELECT * FROM "Workouts" WHERE "AthleteID" = 5;

-- shows all exercises of a certain cathegory
SELECT * FROM "Exercises" WHERE "Category" = 'Cardio';

-- shows the average weight of every exercise done by athletes
SELECT "Exercises"."name",
AVG ("workoutexercises"."Weight") AS "AverageWeight"
FROM "WorkoutExercises"
JOIN "Exercises" ON "WorkoutExercises"."ExerciseID" = "Exercises"."ExerciseID"
GROUP BY "Exercises"."name"
LIMIT 5;

-- shows the exercises a certain workout contains
SELECT "Exercises"."Name",
...
-- shows results of certain competitions found after CompetitionID
...
-- shows best 3 paticipants in a competition
SELECT "Athletes"."Name",
       "Athletes"."Surname",
       "CompetitionResults"."Placement",
       "CompetitionResults"."Total"
...
-- shows all the information for a certain competition
SELECT "CompetitionResults"."ResultID",
